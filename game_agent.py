...
def custom_score(game, player):
    ...
    dis_to_center = ((h - 3) ** 2 + (w - 3) ** 2) ** 0.5

    return my_moves -  opp_moves - dis_to_center
...
def custom_score_2(game, player):
    ...
    h1, w1 = game.get_player_location(player)
    h2, w2 = game.get_player_location(game.get_opponent(player))

    return float((h1 - h2) ** 2 + (w1 - w2) ** 2)
